...
def measure_seed(original_filename,min_area_slider,max_area_slider,cluster_selection,parameterselection,excel_filename1,excel_filename2,excel_filename3,output_filepath):
    ...
    # print(len(data["Grain ID"]))
    # print(len(data["Length"]))
    # print(len(data["Width"]))
    # print(len(data["Area"]))
    # print(len(data["Perimeter"]))
    # print(len(data["Min Radius"]))
    # print(len(data["Max Radius"]))
    # print(len(data["Major Axis"]))
    # print(len(data["Minor Axis"]))
    # print(len(data["Min Diameter"]))
    # print(len(data["Max Diameter"]))
    # print(len(data["Avg Diameter"]))
    # print(len(data["Density"]))
    # print(len(data["Roundness"]))
    # print(len(data["Compactness"]))
    # print(len(data["Elongation"]))
    # print(len(data["Roughness"]))
    # print(len(data["Perimeter Ratio"]))
    # print(len(data["Thickness_max"]))
    # print(len(data["Thickness_min"]))
...
# processed_filename='/storage/davidenochk/measure_seed_img.png'
# excel_filename1='/storage/davidenochk/measure_seeds1.xlsx'
# excel_filename2='/storage/davidenochk/measure_seeds2.xlsx'
# excel_filename3='/storage/davidenochk/grains.xlsx'
