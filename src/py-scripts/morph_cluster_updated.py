...
def morph_clustering(original_filename,min_area_slider,max_area_slider,cluster_selection,ppmm,parameterselection,excel_filename1, excel_filename2,output_filepath):
    ...
    global selected_options, areas, widths, ma_axs, mi_axs, mi_dias, ma_dias, av_dias, perimeters, min_radiis, max_radiis, mn_densitys, roundnesss, compactnesss, elongations, roughnesss, pr_ratios, ma_thicknesss, mi_thicknesss, lengths,df,data,data1,data2
